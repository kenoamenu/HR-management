...
// $id=$_GET['updateid'];
if (isset($_POST['id'], $_POST['name'],$_POST['sex'],$_POST['address'], $_POST['mobile'])) {
  $id=$_POST['id'];
  ...
  $query = "UPDATE `teacherdb` SET id='$id',`fullname`='$fullname',`sex`='$sex',`age`='$age', `salary`='$salary', `address`=' $address', `departments`='$departments'
  , `monthly`='$monthly', `date`='$date', `sector`='$sector', `position`='$position', `expriance`='$expriance'
   , `country`='$country' , `state`='$state', `regein`='$regein', `phone`='$phone', `email`='$email' WHERE `id`='$id'";
